...
export INK_DEV_IMAGE="e1db5ecf81242c621a84a88865d0e291cc35b472bd4a714d8347ddb291250bc4"
...
generate_ink_types() {
  cd "${SCRIPT_DIR}"/../cli/
  docker_ink_dev "ink-wrapper -m ../contract/target/ink/bright_disputes.json | rustfmt +nightly-2023-04-16 --edition 2021 > src/bright_disputes_ink.rs"
...
deploy() {
    ...
    # TODO: 
    # 1. change the docker image, to contain ink-wrapper!
    # 2. install nightly, otherwise CLI will not build!
